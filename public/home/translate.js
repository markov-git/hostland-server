...
const dictionary = {
  ...
  aboutMeText: {
    ru: `<p>Привет!<br><br>Меня зовут Артем, мне 25 и я ищу работу Frontend
                разработчиком.</p>
            <p>Я окончил высшее специальное образование по специальности проектировщик уникальных зданий и сооружений.</p>
            <p>Параллельно с основным обучением, я отучился и получил диплом переводчика в технической сфере.</p>
            <p>Вхождение в мир программирования я начал с языка С++ (увлекался ардуиной). Но через несколько месяцев, я понял, что это не мое. И я решил попробовать веб разработку.</p>
            <p>Уже около года я изучаю Frontend и немного Backend, и я точно могу сказать: Мне это нравится!</p>`,
    en: `<p>Hello!<br><br>My name is Artem, I am 25 years old and now looking for a job as a Junior Frontend Web Developer.</p>
            <p>By my main specialty I am a designer of unique buildings and structures.</p>
            <p>In addition, in my free time, I went to English courses. Now I have a translator's diploma.</p>
            <p>I started learning C++, but after a few months I realized that it was not mine. I decided to study web development.</p>
            <p>I have been studying web development for more than a year and now I can say with confidence - I like it!</p>`,
  },
  mySkills: {
    ru: 'Навыки и Умения', en: 'My Skills',
  },
  semantic: {
    ru: 'Семантика', en: 'Semantic'
  },
  myWorks: {
  ...
  mazeDesc: {
    ru: 'Мультиплеер<br>SSE<br>Алгоритм эйлера<br>Алгоритм A*', en: 'Multiplayer<br>SSE<br>Eller\'s Algorithm<br>A* Algorithm',
  },
  contactMe: {
